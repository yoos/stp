...
<html lang="en" class="wf-athelas1athelas2-n4-active wf-athelas1athelas2-i4-active wf-athelas1athelas2-n7-active wf-active"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <meta name="description" content="a graph visualization library using web workers and jQuery">
    ...
    <!--<script type="text/javascript" src="../arbor_js_ex_files/mxh7kqd.js"></script>-->
...
<body>
  <div id="arbor">
  <div id="nav">
    <a class="back" href="http://arborjs.org/#"></a>
    <p style="display: block; opacity: 1; ">a graph visualization library using web workers and jQuery</p>
  </div>
  <canvas id="sitemap" width="1280" height="486" style="display: inline; opacity: 1; " class=""></canvas>
  ...
  <div id="docs" style="opacity: 0; display: none; ">
    <div id="introduction" style="display: block; ">
      ...
      visualization. More detailed documentation can be found in the <a href="http://arborjs.org/reference">reference</a> section.</p>
      <p>&nbsp;</p>
      ...
      <p>Arbor’s design is heavily influenced by Jeffrey Bernstein’s excellent 
        ...
        <a href="http://arborjs.org/docs/barnes-hut">description</a> of the algorithm.
  ...
  <div id="footer">Copyright 2011 · <a href="http://samizdat.cc/"> Samizdat Drafting Co.</a></div>
</div>  
  <script src="../arbor_js_ex_files/jquery.1.4.4.min.js"></script>
  <script src="../arbor_js_ex_files/jquery.address-1.3.1.min.js"></script>

  <script src="../arbor/lib/arbor.js"></script>
  <script src="../arbor_js_ex_files/arbor-tween.js"></script>
  <script src="../arbor_js_ex_files/arbor-graphics.js"></script>
